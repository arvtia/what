  ...
  return (
    <div className="relative w-80 h-96 bg-neutral-200 rounded-[20px] overflow-hidden group">
      ...
      <div className="absolute bottom-0 right-0 bg-white pt-2 pl-2 rounded-tl-[20px]">
        <button className="bg-black text-white px-8 py-1 mb-3 mr-3 rounded-xl font-bold hover:scale-105 transition-transform">
          Buy Now
        </button>
        ...
        {/* Left Curve */}
        <InvertedCorner className="absolute bottom-0 -left-[24px] w-6 h-6 text-white rotate-90" />
      </div>
    </div>
  );
}