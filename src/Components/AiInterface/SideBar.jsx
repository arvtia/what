...
import { ArchiveIcon, DeleteICon, DownArrowSvg, EditICon, HorizontalDots, ShareIcon1 } from "./svgs/Svg";
         ...
         <div className="mt-3 w-full flex justify-between items-center p-2">
            {
               isActive && (
                  <>
                     ...
                     <div className="px-2 py-1 rounded-md hover:bg-neutral-200" onClick={()=>setIsActiveChat(!isActiveChat)}>
                              ...
                              {isActive &&
                                 History.slice().reverse().map((item, idx) => (
                                    <div className="w-full group" key={idx}>
                                       ...
                                       <p className="text-sm truncate w-[80%]">{item.text}</p>
                                       ...
                                       <div className="relative opacity-0 group-hover:opacity-100 p-2 cursor-pointer ">
                                          ...
                                          />
                                             ...
                                             <div className="w-28 absolute left-1/2 top-5 p-1 rounded-lg bg-neutral-300 shadow-md z-10 opacity-0 scale-95 pointer-events-none 
