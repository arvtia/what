  ...
  return (
    <section className="border-l border-r border-t border-b-0 border-gray-200  p-6 mt-7">
      <div className="flex flex-wrap gap-4 items-center">
         <div className="flex flex-wrap w-full sm:flex-col md:flex-row gap-4">
            <div className="photo border border-gray-200 rounded-lg w-fit h-fit overflow-hidden">
               <img
                  src={image}
                  alt={Name}
            ...
            <div className="flex-1">
               ...
               <p className="text-lg text-neutral-600">{description} <Link to={'/about'} className="font-bold text-neutral-900">learn more</Link></p>
